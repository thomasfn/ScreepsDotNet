...
namespace ScreepsDotNet.Native.Arena
{
    ...
    {
        public static readonly Name Exists = Name.Create("exists");
        ...
        public static readonly Name CostMatrix = Name.Create("costMatrix");
        ...
        public static readonly Name Structure = Name.Create("structure");
